          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <ul class="footer">
              ...
              <li>
                ...
                <a href="https://goo.gl/maps/BWwXaBVodShPj6Y39">
                  Töölönlahdenkatu 4 <br />
                  00100 HELSINKI
                </a>
              </li>
              <li>
                <i class="fa fa-envelope-square footer-icon" aria-hidden="true"></i>
                <a href="mailto:info@doggo.com?subject=Email Subject line">info@doggo.com</a>
              </li>
            </ul>
            <ul class="footer">
              <li>
              ...
              <li>
                <i class="fa fa-map-marker footer-icon" aria-hidden="true"></i>
                <a href="https://goo.gl/maps/LoinaEroZww6DaUX8">
