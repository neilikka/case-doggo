    ...
    return (
        <div>
            <div class="filter" style={hideWhenVisible}>
                <p onClick={() => setFilterVisible(true)}><i class="far fa-plus-square white-background"></i> Filter results</p>
            </div>
            <div class="filter" style={showWhenVisible}>
                <p onClick={() => setFilterVisible(false)}><i class="far fa-minus-square white-background"></i> Filter results</p>
                <div class="row">
                  <div class="col m-2">
                      <b>Type of content:</b>
