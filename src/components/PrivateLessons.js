       ...
       <div>
          ...
          <div class="row d-flex">
                <div class="col-sm-5 col-sx-5 d-flex align-items-center"> 
                    <h5>Private lessons are a good option for those who want lessons when ever and where ever fits them best. They also 
                        suit for dogs who have troubles behaving in groups or who need special combination of taught skills.</h5>               
                </div>
          ...
          <p class="citation">“My rescue dog had great troubles in learning even the basic rules. Courses were out of the question since 
          he could not behave around other dogs. Private lessons were a life-saver!” <br/>- Woman, 45 years old</p>        
                </div>
                <div class="col-sm-5 col-xs-5 d-flex">
                    ...
                    <video height="180" controls>
                        ...
                        <div class="card-body d-flex">
                            <h5 class="card-title align-items-center d-flex small-card-title">Demo video: Basic obedience training for puppies</h5>
                        </div>
                    </div>                    
                </div> 
          </div>          
