...
const FrontPage = () => {
    ...
    return (
       <div>
          <p class="big-title">Welcome to a place where both you and your dog are served with expertise and joy</p>
          ...
          <p class="medium-title">Categories</p>
            ...
            <p class="citation">“I have used Doggo’s services since it was founded in 2015 since they offer a friendly and 
          professional service. They treat customers like real persons and individuals.” <br/>- Woman, 39 years old</p>
