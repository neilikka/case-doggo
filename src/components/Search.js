...
const results = [
    ...
    },
    {
        ...
        text: 'Participating in online courses for the first time can be confusing. We will tell you with videos how everything works from registration and payment to participating in lectures, studying different materials and practicing with you dog.',
        url: '/error'
    },
    {
        id: 4,
    ...
    return (
       <div>
         ...
         <div class="row">
            ...
            <Filter />
            <div class="row">
                <div class="col-sm"><SortButton label="Relevence"/></div>
                <div class="col-sm"><SortButton label="Name"/></div>
                <div class="col-sm"><SortButton label="Type"/></div>
                <div class="col-sm"><SortButton label="Location"/></div>
                <div class="col-sm"><SortButton label="Price"/></div>
                <div class="col-sm"><SortButton label="Duration"/></div>
                <div class="col-sm-3"><SortButton label="Number of meetings"/></div>
            </div>
            <br/>
