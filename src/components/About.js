...
const About = () => {
  return (
    <div>
      ...
      <p class="mx-5">
        Anna Virtanen and Hanna Kuusinen founded Doggo in 2015 in Helsinki. Their dream was to
        provide the best possible services for dogs and their owners. Little by little Doggo grow,
        and in 2017 a new office in Tampere was founded. Nowadays, Doggo has 6 full-time workers and
        4 part-time workers. All of our full-timers and half of our part-timers have at least
        vocational education in animal care. 5 of us have further studies in animal training, 3 of
        us have diploma about dog massaging, and 2 of us have further studies in animal
        physiotherapy.{" "}
      </p>
      <p class="medium-title">Meet our talented professionals</p>
      <CardBig cardlist={workers} />
      <p class="mx-5 text-center">
        The fastest way to contact us is to call (Helsinki 045 111 2222 or Tampere 045 333 4444) or
        email us (<a href="/error">info@doggo.com</a> or firstname.lastname@doggo.com). You can also
        send messages with our <a href="/error">contact form</a>.
      </p>
    </div>
  );
};
