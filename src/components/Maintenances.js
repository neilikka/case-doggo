...
const Maintenances = () => {
    return (
       <div>
          ...
          <p class="big-title">Come to our offices to take care of your dog’s body in a comprehensive way</p>
          <p class="medium-title">Our maintenance services</p>
          <CardBig cardlist={services} />
          <p class="citation">“Of couse I know how to wash my own dogs or cut their nails, but lettings someone else do those chores 
          saves my time tremendously. While my dogs are being taken care of in Doggo, I can shop, work, go to gym or do anything I want!”
            <br/>- Woman, 53 years old</p>
